...
=======
`diet_length.198.2` Length of time respondent was on a diet at age 16

`diet_lost.198.2` How much weight respondent lost on diet at age 16

`diet_gain.198.2` How much weight (if any) respondent gained back after diet at age 16
...
`diet_length.222.2` Length of time respondent was on a diet at age 18

`diet_lost.222.2` How much weight respondent lost on diet at age 18

`diet_gain.222.2` How much weight (if any) respondent gained back after diet at age 18
>>>>>>> parent of 4ae069d (commit)
