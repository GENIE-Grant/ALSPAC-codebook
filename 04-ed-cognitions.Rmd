...
`ti_mean.14` Mean thin-ideal
internalization score

`ti_NA.14` Percent of variables missing
from the thin-ideal internalization measure
...
`pressure_lose_sum.14` Sum of pressure to lose weight scale

`pressure_lose_NA.14` Percent of variables missing from the pressure to lose weight scale

`pressure_musc_sum.14` Sum of pressure to increase muscle scale

`pressure_musc_NA.14` Percent of variables missing from the pressure to increase muscle scale
...
`restraint_sum.14` Sum of the restrained eating items

`emo_eat_sum.14` Sum of the emotional eating items

`emo_eat_sum_d.14` Sum of dichotomous responses
